...
var branchIsUseful = function(github, repo, branch, parentBranches, cb) {
  var someParentBranchAtThisSha =
    parentBranches.filter(function(candidate) {
  ...
  async.waterfall(
    [
      ...
      function(repo, branches, parentbranches, cb) {
        ...
        async.some(
          branches,
          function(branch, someCb) {
            branchIsUseful(github, repo, branch, parentbranches, function(
              err,
              useful
            ) {
